...
DEFINE_string(game, "", "Which game to play: sudoku, freecell");
...
int main(int argc, char* argv[]) {
  ...
  if (FLAGS_game == "sudoku") {
    ...
    auto gameWindow = std::make_shared<GameWindow>(FLAGS_image_file);
    GameAssistant::Freecell::FreecellRecognizer recognizer(gameWindow);
